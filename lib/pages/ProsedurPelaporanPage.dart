      ...
      body: ListView(
        ...
        children: [
          ...
          Card(
            ...
            child: ListTile(
              leading: const Icon(Icons.check_circle_outline, color: Color(0xFF00BF6D)),
              title: const Text('Langkah 1: Login ke Aplikasi'),
              subtitle: const Text('Masuk ke aplikasi SPIR menggunakan akun terdaftar Anda.'),
            ),
          ),
          ...
          Card(
            ...
            child: ListTile(
              ...
              subtitle: const Text('Ambil atau pilih foto dari galeri yang menunjukkan kerusakan infrastruktur.'),
            ),
          ),
          const SizedBox(height: 8),
          Card(
            ...
            child: ListTile(
              ...
              subtitle: const Text('Masukkan lokasi kejadian kerusakan dengan detail.'),
            ),
          ),
          const SizedBox(height: 8),
          Card(
            ...
            child: ListTile(
              ...
              subtitle: const Text('Isi deskripsi kerusakan dengan informasi yang jelas dan lengkap.'),
            ),
          ),
          const SizedBox(height: 8),
          Card(
            ...
            child: ListTile(
              leading: const Icon(Icons.calendar_today, color: Color(0xFF00BF6D)),
          ...
          Card(
            ...
            child: ListTile(
              ...
              subtitle: const Text('Masukkan nama dan nomor telepon Anda sebagai pelapor.'),
            ),
          ),
          const SizedBox(height: 8),
          Card(
            ...
            child: ListTile(
              ...
              subtitle: const Text('Tekan tombol "Kirim Laporan" untuk mengirimkan laporan ke sistem.'),
            ),
          ),
          const SizedBox(height: 16),
          const Text(
